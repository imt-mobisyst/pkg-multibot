...
def generate_launch_description():
    ...
    def map_path(context):
        ...
        file = [os.path.join(get_package_share_directory('multibot_arch'), 'world', 'maps', map, 'map.yaml')]
    ...
    localization = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'params_file': os.path.join(get_package_share_directory('multibot_arch'), 'config', 'nav2', 'nav2_params.yaml'),
            'autostart': 'True',
            'use_sim_time': 'True',
    ...
    def createSimBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot_arch'), 'config/domain_bridge/stage_bridge_config_sim.yaml'), robot_id)
    ...
    def createOperatorBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot_arch'), 'config/domain_bridge/stage_bridge_config_operator.yaml'), robot_id)
