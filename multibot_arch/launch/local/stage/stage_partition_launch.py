...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        GroupAction([
            ...
            SetEnvironmentVariable(name='FASTRTPS_DEFAULT_PROFILES_FILE', value=os.path.join(get_package_share_directory('multibot_arch'), 'config', 'dds_partitions', 'stage_config.xml')),
        ...
        *robots,
        ...
        GroupAction([
            SetEnvironmentVariable(name='RMW_FASTRTPS_USE_QOS_FROM_XML', value="1"),
            SetEnvironmentVariable(name='FASTRTPS_DEFAULT_PROFILES_FILE', value=os.path.join(get_package_share_directory('multibot_arch'), 'config', 'dds_partitions', 'operator_config.xml')),
