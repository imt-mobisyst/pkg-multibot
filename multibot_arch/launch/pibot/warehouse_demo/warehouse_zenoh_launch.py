...
def generate_launch_description():
    ...
    def createOperatorBridge(context):
        ...
        configFilePath = createConfigFile(
            os.path.join(get_package_share_directory('multibot_arch'), 'config', 'zenoh', 'kobuki', 'bridge_config_robot.json5'),
    ...
    return LaunchDescription([
        ...
        GroupAction([
            ...
            SetEnvironmentVariable('CYCLONEDDS_URI', 
                os.path.join(get_package_share_directory('multibot_arch'), 'config', 'zenoh', 'kobuki', 'local_cyclonedds.xml')),
