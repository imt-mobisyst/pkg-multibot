...
def generate_launch_description():
    ...
    def createSimBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot'), 'config/domain_bridge/stage_bridge_config_sim.yaml'), robot_id)
    ...
    def createOperatorBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot'), 'config/domain_bridge/stage_bridge_config_operator.yaml'), robot_id)
