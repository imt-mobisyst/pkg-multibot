...
def generate_launch_description():
    ...
    def createSimBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot'), 'config', 'zenoh', 'stage', 'bridge_config_robot_sim.json5'), robot_id)
    ...
    def createOperatorBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('multibot'), 'config', 'zenoh', 'stage', 'bridge_config_robot_operator.json5'), robot_id)
