...
def generate_launch_description():
    ...
    def local_config_path(context):
        ...
        config_file_path = os.path.join(get_package_share_directory('multibot'), 'config', 'dds_partitions','robot_local_debug_config.xml')
    ...
    def shared_config_path(context):
        ...
        # Get configuration file
        config_file_path = os.path.join(get_package_share_directory('multibot'), 'config', 'dds_partitions','robot_shared_config.xml')
        target_path = createConfigFile(config_file_path, robot_id)
