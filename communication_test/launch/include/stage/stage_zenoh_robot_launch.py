...
def generate_launch_description():
    ...
    def createConfigFile(originalPath, robotId):
        targetPath = originalPath.replace('stage_bridge_config_robot', f'/build/stage_bridge_config_robot{robotId}')
    ...
    def createSimBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('communication_test'), 'config/zenoh/stage_bridge_config_robot_sim.json5'), robot_id)
    ...
    def createOperatorBridge(context):
        ...
        configFilePath = createConfigFile(os.path.join(get_package_share_directory('communication_test'), 'config/zenoh/stage_bridge_config_robot_operator.json5'), robot_id)
